...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-codegraph': { kind: 'none', reason: 'Browser-side settings page and composer dock; registers nothing model-facing.' },
  'packages/codegraph/codegraph-index': { kind: 'indirect', reason: 'The host index manager never registers a model surface; dsh-tool-codegraph owns the model-facing tools and guidance.' },
  ...
  'packages/client/ui-plan': { kind: 'indirect', reason: 'The chip dispatches /plan off; dsh-plan-handoff owns the model-visible policy, exit tool, and logged state.' },
  ...
  'packages/client/ui-git-graph': { kind: 'none', reason: 'Browser-side Git projection; registers nothing model-facing.' },
  'packages/client/ui-ssh': { kind: 'none', reason: 'Browser-side SSH projection; registers nothing model-facing.' },
  'packages/client/ui-task-board': { kind: 'none', reason: 'Browser-side task-board projection; registers nothing model-facing.' },
  'packages/client/ui-usage-stats': { kind: 'none', reason: 'Browser-side usage projection; registers nothing model-facing.' },
  'packages/client/ui-workspace-inspector': { kind: 'none', reason: 'Browser-side workspace-file projection; registers nothing model-facing.' },
  ...
  'packages/session/usage-stats': { kind: 'none', reason: 'The service derives a client-facing read model from already-logged session events and registers nothing model-facing.' },
  'packages/schedule/task-board': { kind: 'none', reason: 'The service stores browser-owned tasks and registers nothing model-facing.' },
  ...
  'packages/workspace/workspace-files': { kind: 'none', reason: 'The loopback file service serves browser requests and registers nothing model-facing.' },
  'packages/workspace/workspace-git': { kind: 'none', reason: 'The loopback Git service serves browser requests and registers nothing model-facing.' },
