...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  CodegraphIndexStatus: 'codegraph.md',
  CodegraphSettings: 'codegraph.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  FileVersion: 'workspace-file version token is owned by packages/workspace/workspace-files/README.md',
  GitGraphEntry: 'workspace Git graph row is owned by packages/workspace/workspace-git/README.md',
  GitStatusEntry: 'workspace Git status row is owned by packages/workspace/workspace-git/README.md',
  SshHost: 'secret-bearing SSH host record is owned by packages/ssh/ssh/README.md',
  SshHostId: 'SSH host identity is owned by packages/ssh/ssh/README.md',
  SshHostSummary: 'secret-free SSH host projection is owned by packages/ssh/ssh/README.md',
  TaskId: 'task-board identity is owned by packages/schedule/task-board/README.md',
  TaskView: 'task-board browser projection is owned by packages/schedule/task-board/README.md',
  UsageStatsRequest: 'usage-statistics range request is owned by packages/session/usage-stats/README.md',
  UsageStatsSnapshot: 'usage-statistics response is owned by packages/session/usage-stats/README.md',
  WorkspaceFileEntry: 'workspace file entry projection is owned by packages/workspace/workspace-files/README.md',
  WorkspaceFilePreview: 'workspace text preview is owned by packages/workspace/workspace-files/README.md',
