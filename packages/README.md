...
| [`codegraph/`](codegraph/README.md) | Semantic code-index tools and Web host index lifecycle over the bundled `@colbymchenry/codegraph` engine | Product — stable API |
