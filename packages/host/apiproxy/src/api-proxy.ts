 ...
 * `codegraph` namespace is the Web index-lifecycle preference (`autoInit`).
 */
const PRODUCT_SETTINGS_NAMESPACES = new Set(['ui-onboarding', AGENT_PRESET_SETTINGS_NAMESPACE, 'codegraph'])
