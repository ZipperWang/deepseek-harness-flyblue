...
describe('SettingsPanel navigation', () => {
  ...
  it('gives every section a nav glyph, distinct for the ids the shell knows', () => {
    ...
    // Named section ids get their own glyph; every other section — including
    // one this package never heard of — shares the gear.
